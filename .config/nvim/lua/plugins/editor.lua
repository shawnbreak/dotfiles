    ...
    },
    {
        ...
        config = function()
            require("nvim-treesitter.configs").setup {
                ensure_installed = { "c", "lua", "vim", "vimdoc", "query", "markdown", "markdown_inline", "python", "awk", "bash", "cmake", "cpp", "css", "csv", "dockerfile", "editorconfig", "go", "json", "html", "java", "jq", "javascript", "make", "nginx", "po", "rust", "typescript", "vue", "xml", "yaml" },
                sync_install = false,
                auto_install = false,
                ignore_install = {},
                modules = {},
